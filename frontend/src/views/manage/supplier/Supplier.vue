...
export default {
  ...
  methods: {
    handlesupplierViewClose () {
      this.supplierView.visiable = false
    },
    handlesupplierViewOpen (row) {
      this.supplierView.data = row
      this.supplierView.visiable = true
    },
    selectShopList () {
    ...
    editStatus (row, status) {
      this.$post('/cos/supplier-info/account/status', { supplierId: row.id, status }).then((r) => {
